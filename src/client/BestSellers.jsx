...
import img1 from "../assets/bestSeller/1.png";
import img2 from "../assets/bestSeller/2.jpg";
import img3 from "../assets/bestSeller/3.png";
const data = [
  {
    title: "Women Floral Print Cotton Midi Dress, Short Sleeve",
    image: img1,
    badge: "New",
        ...
        {data.map((item, idx) => (
          <div key={idx} className="px-2">
            <Card
              ...
              cover={
                <div className="relative">
                  ...
                  {/* View button overlay */}
                  <div className="absolute bottom-0 w-full bg-gray-200 bg-opacity-50 text-white text-center py-2">
            ...
            >
              ...
              <p className="text-gray-500 text-md font-bold">{item.category}</p>
